    ...
    <section id="experience" className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative zoom-105">
        ...
        <div className="relative">
          <div className="bg- timeline-glow absolute left-0 md:left-1/2 top-0 bottom-0 w-0.5 bg-linear-to-b from-primary/70 via-primary/30 to-transparent md:-translate-x-1/2 shadow-[0_0_25px_rgba(32,178,166,0.8)]" />
